...
public class BaseClass {
	...
	public static void launchApplication() {
		...
		pro = new Properties();
		File proFile = new File(System.getProperty("user.dir") + ".//src/test/java/com/Luma/Config/config.properties");
		dataPro = new Properties();
		File dataFile = new File(
				System.getProperty("user.dir") + ".//src/test/java/com/Luma/TestData/TestData.properties");
